...
public final class FragmentChatBinding implements ViewBinding {
  ...
  @NonNull
  public final ConstraintLayout fragmentChat;

  @NonNull
  public final RecyclerView rvList;

  private FragmentChatBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnSend,
      @NonNull Toolbar chatToolbar, @NonNull ConstraintLayout constraintLayout,
      @NonNull EditText etChatting, @NonNull ConstraintLayout fragmentChat,
  ...
  public static FragmentChatBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ConstraintLayout fragmentChat = (ConstraintLayout) rootView;
      ...
      return new FragmentChatBinding((ConstraintLayout) rootView, btnSend, chatToolbar,
          constraintLayout, etChatting, fragmentChat, rvList);
    }
